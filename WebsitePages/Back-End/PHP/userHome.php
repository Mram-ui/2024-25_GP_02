                        ...
                        <?php foreach ($pastEvents as $index => $event): ?>
                            <div class="EventsDetalisDes">
                                ...
                                <div class="eventLinks">
                                    ...
                                    <a href="#" class="EventD" style="text-decoration: none;">
                                        <p>View Report</p>
                                    </a>
                                </div>
                            </div>
                        ...
                        <?php foreach ($currentEvents as $index => $event): ?>
                            ...
                            <div class="EventsDetalisDes">
                                ...
                                <div class="eventLinks">
                                    ...
                                    <!-- <a href="../../Back-End/PHP/dashboard.php?eventId=" style="text-decoration: none;">
                                        <p class="EventD">View Dashboard</p>
                                    </a> -->
                                    <a href="http://localhost:5000/?companyID=<?= $eventID ?>" style="text-decoration: none;">
                                        <p class="EventD">View Dashboard</p>
                                    </a>
