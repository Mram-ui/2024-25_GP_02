        ...
        <div id="main" class="main">
            <div class="headerTitle">
                ...
                <button class="button" type="button" 
                    ...
                    <span class="button__text" style="transform: translateX(35px); color: #fff; font-weight: 600; transition: color 0.3s; margin-left: 10px;" onclick="enableEditing()">Edit</span>
                </button>
            </div>
        ...
        <script>
          ...
          confirmDeleteButton.addEventListener('click', async () => {
            ...
            if (response.ok) {
                ...
                notificationsContainer.style.zIndex = '1000'; // Above the overlay
